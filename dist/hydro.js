...
define('util/fsm',['class'], function(Class)
{
	/**
	 *
	 * @param condition
...
define('util/parser',['util/fsm'], function(FSM)
{
	var Machines = {
...
define('util',['require','util/acceptValue','util/camelcase','util/prefixClass','util/support','util/frame','util/unitNumber','util/parser'],function(require)
{
	return {
